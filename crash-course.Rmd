...
One of the greatest things about this Master's is the variety of the student's locations and backgrounds. This promote a broader global approach and allow us to share different points of view during the lectures.
...
```{r plots, echo=FALSE, message=FALSE, results = FALSE, out.width='75%', fig.show='hold'}
